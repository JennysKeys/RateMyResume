...
async function initialize() {
    ...
    let CURRENT_PAGE =
        parseInt(localStorage.getItem("currentPage")) || HOME_PAGE;
    ...
    let curr_user = await getCurrentUserUUID();
    ...
    async function submitComment() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                document.getElementById("largeCommentInput").style.display =
                    "none";
