document
    .getElementById("fetchTestAuthenticateTokenButton")
        ...
        fetch("/test-authenticate-token", {
            ...
            .then((response) => {
                if (response.ok) {
                    ...
                    throw new Error(
                        "Failed to authenticate token or request is unauthorized"
                    );
                }
            })
            .then((data) => {
            ...
            .catch((error) => {
                ...
                alert(
                    "Error calling /test-authenticate-token: " + error.message
